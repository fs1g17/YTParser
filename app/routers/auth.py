...
@router.get("/authorise/autoCode", response_class=HTMLResponse)
async def auth_code_auto(code: str, request: Request):
    try:
        ...
        message = "You authenticatd yourself successfully."
